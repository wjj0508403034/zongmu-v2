...
public class BusinessExceptionHandler {
	private static Logger logger = LoggerFactory
			.getLogger(BusinessExceptionHandler.class);
	...
	public ResponseEntity<Object> UnexpectedError(Exception exception) {
		...
		return this
				.BusinessError(new BusinessException(ErrorCode.General_Error));
	}

	@ExceptionHandler(BadCredentialsException.class)
	public ResponseEntity<Object> UnexpectedError(
			BadCredentialsException exception) {
		logger.error("BadCredentialsException", exception);
		return this.BusinessError(new BusinessException(
	...
	public ResponseEntity<Object> BusinessError(
		...
		businessException.setMessage(this.localeService
				.getErrorMessage(businessException.getCode()));
